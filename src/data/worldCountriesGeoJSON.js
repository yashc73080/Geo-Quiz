...
// Helper functions to map countries to regions
...
const getSubregion = (countryName) => {
  const continent = getContinent(countryName);
  
  // Northern America
  if (['United States of America', 'Canada'].includes(countryName)) {
